// GP White Resin and GP Clear Resin share one base specification.
//
// The supplier Safety Data Sheet for GP White Resin (SPR-SDS-GWR, Rev. 01,
// 8 August 2026) states that it is built on the same orthophthalic GP base
// resin system as GP Clear Resin, that the resin fraction, styrene content and
// processing characteristics are manufacturer-confirmed as shared, and that a
// white pigment/colourant package is the difference. It documents the product
// as white-pigmented.
//
...
export default {
  en: {
    ...
    seoDescription:
      "GP White Resin is a white-pigmented general-purpose orthophthalic polyester resin on the shared GP base specification, supplied and imported for Nepal by Samrat FRP Traders.",
    intro: [
    ...
    buyerNotes: [
      {
        ...
        text: "GP White Resin is a general-purpose laminating grade and is not a substitute for a mould-surface gelcoat. Where the requirement is the same base resin without pigment, GP Clear Resin is the clear grade; for lamination-focused work, review Lamination Resin.",
      },
      {
        title: "One specification, two appearances",
    ...
    faqs: [
      {
        ...
        a: "A white-pigmented, general-purpose orthophthalic polyester resin built on the same base resin system as GP Clear Resin. Samrat Poly Resins, India lists it for FRP panels, moulding, hand layup, spray-up, cooling towers and water storage tanks.",
      },
      {
        q: "What are its viscosity, gel time and styrene content?",
        a: "The shared GP base specification applies: 350–450 cPs viscosity, gel time under 8 minutes and 33–40% styrene content, with a cure time of 45 minutes to 1.5 hours. These come from the Technical Data Sheet issued for this grade (SPR-TDS-GCR), and the supplier Safety Data Sheet confirms they are shared with GP Clear Resin.",
      },
      {
      ...
      {
        q: "How is it cured?",
        a: "As a room-temperature polyester system with an MEKP catalyst and, because the grade is non-accelerated, a cobalt octoate accelerator. The shared Technical Data Sheet gives the dosage for the base system; confirm it for your own workshop conditions.",
      },
    ],
    applicationsIntro:
      "Samrat Poly Resins, India lists this grade for FRP panels and general-purpose moulding, hand layup and spray-up work, cooling towers and water storage tanks.",
    features: [
      "White-pigmented general-purpose orthophthalic polyester resin",
      "Same base specification as GP Clear Resin: 350–450 cPs, gel time under 8 minutes",
  ...
  ne: {
    ...
    seoDescription:
      "GP White Resin साझा GP base specification मा आधारित white-pigmented general-purpose orthophthalic polyester resin हो, जुन नेपालका लागि Samrat FRP Traders ले आपूर्ति र आयात गर्छ।",
    intro: [
    ...
    buyerNotes: [
      {
        title: "Grade छनोट",
        text: "GP White Resin general-purpose laminating grade हो; यो mould-surface gelcoat को विकल्प होइन। Pigment बिनाको उही base resin चाहिए GP Clear Resin clear grade हो, र लेमिनेसनकेन्द्रित कामका लागि Lamination Resin हेर्नुहोस्।",
      },
      {
        title: "एउटै specification, दुई रूप",
    ...
    faqs: [
      {
        ...
        a: "GP Clear Resin कै base resin system मा बनेको white-pigmented, general-purpose orthophthalic polyester resin। Samrat Poly Resins, India ले यसलाई FRP panel, moulding, hand layup, spray-up, cooling tower र पानी भण्डारण ट्याङ्कीका लागि सूचीबद्ध गरेको छ।",
      },
      {
        q: "यसको viscosity, gel time र styrene content कति छ?",
        a: "साझा GP base specification लागू हुन्छ: 350–450 cPs viscosity, 8 मिनेटभन्दा कम gel time र 33–40% styrene content, cure time 45 मिनेटदेखि 1.5 घण्टा। यी यस grade का लागि जारी Technical Data Sheet (SPR-TDS-GCR) बाट लिइएका हुन्, र आपूर्तिकर्ता Safety Data Sheet ले यी GP Clear Resin सँग साझा भएको पुष्टि गर्छ।",
      },
      {
      ...
      {
        q: "कसरी cure गरिन्छ?",
        a: "Room temperature मा MEKP catalyst ले, र grade non-accelerated भएकाले cobalt octoate accelerator सँगै। साझा Technical Data Sheet ले base system को dose दिन्छ; आफ्नो कार्यशालाको अवस्थाका लागि पुष्टि गर्नुहोस्।",
      },
    ],
    applicationsIntro:
      "Samrat Poly Resins, India ले यस grade लाई FRP panel र सामान्य moulding, hand layup र spray-up कार्य, cooling tower र पानी भण्डारण ट्याङ्कीका लागि सूचीबद्ध गरेको छ।",
    features: [
      "White-pigmented general-purpose orthophthalic polyester resin",
      "GP Clear Resin कै base specification: 350–450 cPs, 8 मिनेटभन्दा कम gel time",
