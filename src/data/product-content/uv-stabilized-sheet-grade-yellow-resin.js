export default {
  en: {
    seoTitle: "UV Stabilized Sheet Grade Yellow Resin — Nepal Supplier",
    seoDescription:
    ...
    buyerNotes: [
      {
        title: "UV-stabilised, not UV-cured",
        text: "This resin cures with an MEKP catalyst in the normal way. The UV stabilisation addresses weathering in service, not the curing method. If you have been offered a resin that hardens under a UV lamp, that is a different product class entirely.",
      },
      {
        title: "Pre-pigmented at the supplier",
    ...
    faqs: [
      {
        ...
        a: "No. It is UV-stabilised, not UV-curing. It cures with an MEKP catalyst at ambient temperature like other unsaturated polyester sheet grades. The UV stabilisation is about resisting sunlight during the sheet's service life.",
      },
      {
      ...
      },
      {
        ...
        a: "No. The resin is supplied already pigmented yellow. Fabricators choose a factory-pigmented grade precisely to avoid colour variation between hand-mixed batches.",
      },
      {
    ...
    features: [
      ...
      "Cures with an MEKP catalyst — it is not a UV-cured product",
      "Supplied and imported for the Nepal market by Samrat FRP Traders",
    ],
    industries: [
      "FRP roofing sheet manufacturing",
      "Cladding & building panels",
      "Coloured FRP sheet production",
      "Industrial moulded panels",
    ],
  },
  ne: {
    seoTitle: "UV Stabilized Sheet Grade Yellow Resin — नेपाल आपूर्तिकर्ता",
    seoDescription:
    ...
    buyerNotes: [
      {
        title: "UV-stabilised हो, UV-cured होइन",
        text: "यो resin सामान्य रूपमा MEKP catalyst ले जम्छ। UV stabilisation ले प्रयोगमा रहँदा घामबाट हुने क्षति कम गर्छ, जम्ने तरिकासँग यसको सम्बन्ध छैन। UV बत्तीले कडा हुने resin भनेर कसैले दिएको छ भने त्यो बिल्कुलै अर्को वर्गको उत्पादन हो।",
      },
      {
        title: "आपूर्तिकर्ताकहाँ नै रङ मिसिएको",
    ...
    faqs: [
      {
        q: "यो resin UV बत्तीले जम्छ?",
        a: "जम्दैन। यो UV-stabilised हो, UV-curing होइन। अन्य unsaturated polyester sheet grade जस्तै MEKP catalyst ले सामान्य तापक्रममा जम्छ। UV stabilisation प्रयोगका क्रममा घाम सहने कुरासँग सम्बन्धित छ।",
      },
      {
      ...
      },
      {
        ...
        a: "पर्दैन। resin पहिल्यै पहेँलो रङमा आपूर्ति हुन्छ। हातले मिसाउँदा ब्याचैपिच्छे रङ फरक पर्ने समस्या हटाउन नै फेब्रिकेटरहरूले factory-pigmented grade रोज्छन्।",
      },
      {
        q: "कहाँ प्रयोग हुन्छ?",
    ...
    features: [
      ...
      "MEKP catalyst ले जम्छ — UV बत्तीले जम्ने उत्पादन होइन",
      "Samrat FRP Traders द्वारा नेपाली बजारका लागि आपूर्ति र आयात",
    ],
    industries: [
      "FRP छाना पाता उत्पादन",
      "Cladding र भवन प्यानल",
      "रङीन FRP sheet उत्पादन",
      "औद्योगिक moulded प्यानल",
    ],
  },
};
