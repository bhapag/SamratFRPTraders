...
export const extraApplications2 = [
  {
    ...
    faqs: [
      ...
      {
        q: 'Where are the technical figures for this grade?',
        a: 'On the ISO Polyester Resin product page, taken from the supplier Technical Data Sheet (SPR-TDS-IPR, Rev. 01, September 2026) with the issuer named. This guide does not repeat them, and the sheet does not publish chemical-resistance data for specific media: for a particular chemical, concentration and temperature, ask us and we will put the question to Samrat Poly Resins, India.',
      },
      {
...

  {
    ...
    whatTheyManufacture:
      'Fabricators in this category produce one-piece and sectional pool shells, water slide flumes and curved sections, pool steps, ledges and surrounds, splash pads and play features, and the moulded fittings that go with them. The product artwork issued by Samrat Poly Resins, India for <a href="/products/iso-gelcoat/">ISO Gelcoat</a> lists swimming pools and water slides among its contexts. The supplier Technical Data Sheet for the grade does not: it lists mould-face surface coats, sanitaryware and transport panel moulding, exterior panel moulding and parts whose surface must hold gloss and colour, and describes the grade for water contact and outdoor service. That gap is why the boundaries below matter. The commercial reality is that these are highly visible products where a dull or blistered surface is a complaint even when the laminate behind it is sound.',
    whySuitable:
      'ISO Gelcoat is an isophthalic gelcoat. The isophthalic backbone is described across the industry as more resistant to hydrolysis than an orthophthalic one, which is why it is the route normally specified where a moulded face stays wet or has to hold gloss outdoors. Two honest boundaries belong on this page. First, isophthalic is not the same as ISO/NPG: neopentyl glycol modification is a further compositional step that the marine and immersion trade specifies for its most demanding work, and nothing in the documentation we hold says this grade carries it. Second, the supplier Technical Data Sheet (SPR-TDS-IGC) rates water resistance as good to very good and reports water absorption of approximately 18 mg after 24 hours at 23 °C, but it does not address continuous immersion in chemically treated water. Where that performance has to be evidenced, ask for it specifically rather than relying on the family name.',
    requiredCharacteristics: [
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'We cannot evidence that, and we will not claim it. The isophthalic route is the one the industry specifies for wet service, which is why the grade is positioned here, but continuous immersion in chemically treated water is a performance question that belongs to the manufacturer’s documentation for the specific grade. The supplier Technical Data Sheet for ISO Gelcoat reports water resistance and a 24-hour water absorption figure, but it does not cover continuous immersion in treated pool water. Ask us before committing a pool run and we will put the question to Samrat Poly Resins, India.',
      },
      {
...

  {
    ...
    whySuitable:
      '<a href="/products/uv-stabilized-sheet-grade-yellow-resin/">UV Stabilized Sheet Grade Yellow Resin</a> is a pre-pigmented unsaturated polyester sheet grade that its supplier Technical Data Sheet (SPR-TDS-USY) describes as UV-stabilised — a benzotriazole-type UV absorber with a HALS light stabiliser — for outdoor sheet, cladding and panel work. Two things follow. The colour arrives mixed at the manufacturer rather than dosed on the line, which is what removes batch-to-batch colour drift from a production operation. And the stabiliser package addresses weathering in service, not curing: this resin is catalysed with a peroxide hardener at workshop temperature like any other sheet grade. The sheet’s values, including a 1,000-hour xenon-arc weathering result, are published on the product page with the issuer named; this guide does not repeat them.',
    requiredCharacteristics: [
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'Both are pre-pigmented yellow sheet grades. The supplier Technical Data Sheet describes this one as UV-stabilised, with a UV absorber and a HALS light stabiliser, for prolonged outdoor exposure. Where sheet sits in direct sun for years that is the distinction to ask about; for sheltered or indoor panels the <a href="/products/sheet-grade-yellow-resin/">standard sheet grade</a> may be the sensible specification.',
      },
      {
        q: 'How many years will the sheet last?',
        a: 'We do not publish a service-life figure, and a figure offered without context is worth little. The supplier Technical Data Sheet reports a 1,000-hour xenon-arc laboratory exposure result, which is a comparison point, not a lifespan. Service life depends on the resin formulation, the stabiliser and surfacing system, the sheet construction, how severe the climate is and how the roof is maintained. What can be said is what degrades: sunlight breaks down resin at the surface, which shows as discoloration, chalking and eventually fibres standing proud.',
      },
      {
