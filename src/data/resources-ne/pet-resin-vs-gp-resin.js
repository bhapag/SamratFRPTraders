export default {
  ...
  comparisonTable: {
    ...
    rows: [
      [
        "Published context",
        "PET sheets, fibre sheets, FRP sheet lamination र panels",
        "General-purpose FRP product route"
      ],
      [
        "Product identity",
        "PET-modified liquid unsaturated polyester sheet grade",
        "आफ्नै data सहितको छुट्टै published GP grade"
      ],
      [
    ...
    note: "यो तुलनाले कुनै पनि product लाई universally better भनी प्रस्तुत गर्दैन, न त एउटा grade को specification, application वा finished-product result अर्कोमा transfer गर्छ।"
  },
  sections: [
    {
    ...
    {
      heading: "Specific enquiry तयार गर्नुहोस्",
      body: [
        "तयार component, थाहा भएमा intended product route, आवश्यक material रूप, सान्दर्भिक प्राविधिक data, quantity, packaging need, delivery location र अनुरोध गरिएको documentation बताउनुहोस्। यसले Samrat FRP Traders लाई PET वा GP route जाँच गर्न तथ्यगत आधार दिन्छ।"
      ]
    }
  ],
  faqs: [
