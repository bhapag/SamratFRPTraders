export default {
  ...
  faqs: [
    ...
    },
    {
      ...
      a: "होइन। यी आपूर्ति र typical liquid-resin डाटा हुन्। Repository ले यस grade का लागि finished putty, body-filler, sanding, adhesion, shrinkage, hardness वा finished-sheet performance दाबी प्रकाशित गर्दैन।"
    },
    {
      q: "Polyester Putty Resin RFQ मा के समावेश हुनुपर्छ?",
      a: "आवश्यक liquid material form, अपेक्षित PET-sheet, fibre-sheet, FRP-sheet वा panel application, आवश्यक प्रकाशित properties वा documentation, quantity, packaging need र delivery location समावेश गर्नुहोस्।"
    }
  ],
  recommendedLinks: [
    {
  ...
  sections: [
    ...
    {
      heading: "Liquid डाटालाई finished-product नतिजाबाट अलग राख्नुहोस्",
      body: [
        "यी मानहरूले आपूर्ति गरिएको liquid resin वर्णन गर्छन्। तिनले finished PET sheet, fibre sheet, FRP panel, finished putty वा body filler को performance स्थापित गर्दैनन्।",
        "यस grade का लागि कुनै formulation, filler loading, catalyst ratio, curing schedule, sanding, adhesion, shrinkage, hardness, flexibility वा repair-performance नतिजा प्रकाशित छैन। यी विषयहरू liquid-resin table बाट जानाजानी अनुमान गरिएका छैनन्।"
      ]
    },
    {
